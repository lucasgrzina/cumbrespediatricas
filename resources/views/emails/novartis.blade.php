                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                          ...
                          <td valign="top">
                            ...
                            <table width="400" border="0" cellspacing="0" cellpadding="0" align="center" class="em_wrapper">

                              <tr>

                                <td align="left" class="em_align_cent" style="font-family:'Open Sans', Arial, sans-serif; font-size:12px; line-height:18px; color:#fff; text-decoration:none; text-align: center;">

                                  Si no puede ver este correo haga <a href="https://staging.identidad-digital.com.ar/agus/eventos-id/novartis/email.html" target="_blank" style="color: #fff;">Click aqu&#237;</a>
