...
use App\Http\Requests\Admin\CUTriviasRequest;
use App\Repositories\TriviasRepository;
use Illuminate\Http\Request;
use Prettus\Repository\Criteria\RequestCriteria;
use Response;

class TriviasController extends CrudAdminController
{
    protected $routePrefix = 'trivias';
    protected $viewPrefix  = 'admin.trivias.';
    protected $actionPerms = 'trivias';

    public function __construct(TriviasRepository $repo)
    {
    ...
    public function store(CUTriviasRequest $request)
    {
    ...
    public function update($id, CUTriviasRequest $request)
    {
